...
### Bulgu 1.2 — Home, konser uygulamasını "oyun" gibi gösteriyor
...
### Bulgu 1.4 — Menüde "yakında" kartları ürünü yarım gösteriyor
...
### Bulgu 4.2 — HomeScreen'de her açılışta zorunlu 600ms skeleton gecikmesi
...
### Bulgu 5.3 — Daily Song streak'inde kayıp-kaçınma (loss aversion) kullanılmıyor
